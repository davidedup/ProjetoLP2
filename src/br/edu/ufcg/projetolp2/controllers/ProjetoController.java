...
public class ProjetoController {
	...
	public int getRendimento(int codigo) {
		...
		if (projeto instanceof Pet) {
			...
			throw new ProjetoException("Extensao nao possui Rendimento");
		} else if (projeto instanceof Ped){
			return ((Ped) projeto).getPatentes();
		} else {
			throw new ProjetoException("Monitoria nao possui Rendimento");
		}
	}
	...
	public String getDisciplina(int codigo) {
		Projeto projeto = this.getProjeto(codigo);
		if (projeto instanceof Pet) {
			throw new ProjetoException("Pet nao possui Disciplina");
		} else if (projeto instanceof Extensao) {
			throw new ProjetoException("Extensao nao possui Disciplina");
		} else if (projeto instanceof Ped){
			throw new ProjetoException("Ped nao possui Disciplina");
		} else {
	...
	public String getPeriodo(int codigo) {
		Projeto projeto = this.getProjeto(codigo);
		if (projeto instanceof Pet) {
			throw new ProjetoException("Pet nao possui Periodo");
		} else if (projeto instanceof Extensao) {
			throw new ProjetoException("Extensao nao possui Periodo");
		} else if (projeto instanceof Ped){
			throw new ProjetoException("Ped nao possui Periodo");
		} else {
	...
	public void setPeriodo(int codigo, String periodo) {
		if (StringUtil.isStringNula(periodo) || StringUtil.isStringVazia(periodo)){
			throw new ValidacaoException("Erro na atualizacao de projeto: Periodo nulo ou vazio");
		}
		
		if (Integer.valueOf(periodo) < 0) {
			throw new ValidacaoException("Erro na atualizacao de projeto: Valor de periodo invalido");
		}
