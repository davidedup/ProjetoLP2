...
public class MainController {
	 ...
	 * @param categoria
	 *            - Determina a categoria do projeto Coopera��o,
	 *            PIBIC,PIBITI ou PIVIC
	 * @param prodTecnica
	 *            - quatidade de produções tecnicas
	 * @param prodAcademica
	...
	public void associaProfissional(String cpfPessoa, int codigoProjeto, String cargo, double valorHora, int qntHoras) {
		try {
			...
			Participacao participacao = new Participacao(projeto, pessoa, qntHoras, valorHora,
	...
	/**
	 * Faz a associação de um pós-graduando a um projeto e registra em pessoa
	 * e projeto a nova participacao
	 * 
	 * @param cpfPessoa
	 *            - cpf da pessoa a ser associada
	 * @param codigoProjeto
