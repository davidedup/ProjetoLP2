...
//		}
	 ...
	 * 
	 * @param cpf
	 *            - CPF é uma String unica da pessoa a ser cadastrada
	 * @param nome
	 ...
	 * 
	 * @param cpf
	 *            - CPF da pessoa a ser editada
	 * @param atributo
	 *            - atributo de Pessoa que se deseja editar
	 * @param valor
	 *            - Novo valor que o atributo escolhido editado irá ter
	 */
	 ...
	 * 
	 * @param cpf
	 *            - CPF da pessoa que se quer a informação
	 * @param atributo
	 *            - Qual o atributo de pessoa que irá ser retornardo
	 ...
	 * 
	 * @param cpf
	 *            - CPF da pessoa que se deseja remover
	 */
	 ...
	 *            - nome do projeto PET
	 * @param objetivo
	 *            - descrição do objetivo do projeto PET
	 * @param impacto
	 ...
	 *            - rendimento que varia de 0-100%
	 * @param prodTecnica
	 *            - quatidade de produções tecnicas
	 * @param prodAcademica
	 ...
	 * 
	 * @param nome
	 *            - nome do projeto do tipo P&D
	 * @param categoria
	 *            - Determina a categoria do projeto Coopera��o, PIBIC,PIBITI ou
	 *            PIVIC
	 * @param prodTecnica
	 *            - quatidade de produções tecnicas
	 * @param prodAcademica
	 *            - quantidade de procuções acadêmicas
	 * @param patentes
	 *            - quantidades de patentes
	 * @param objetivo
	 ...
	 * 
	 * @param nomeProjeto
	 *            - nome do projeto que se deseja recuperar o codigo
	...
	/**
	 * Recebe o codigo e um atributo do projeto e edita uma informacao do
	 * projeto com base no atributo requerido com um novo valor que foi recebido
	 * 
	 * @param codigo
	 *            - codigo do projeto a ser editado
	 * @param atributo
	 *            - atributo do projeto que se deseja editar
	 * @param valor
	 *            - novo valor que o atributo requerido ser� atulizado
	 */
	 ...
	 * 
	 * @param cpfPessoa
	 *            - cpf da pessoa a ser associada
	 * @param codigoProjeto
	 *            - projeto ao qual o professor ser� associado
	 * @param coordenador
	 *            - Flag para saber se � um professor coordenador
	 * @param valorHora
	 *            - valor R$ da hora do professor
	 * @param qntHoras
	 *            - quantidade de horas semanais dedicada ao projeto
	 */
	public void associaProfessor(String cpfPessoa, int codigoProjeto, boolean coordenador, double valorHora,
		...
		try {
			...
			participacao = new ParticipacaoProfessor(projeto, pessoa, qntHoras, valorHora, coordenador);
	...
	/**
	 * Faz a associação de um graduando a um projeto e registra em pessoa e
	 * projeto a nova participacao
	 * 
	 * @param cpfPessoa
	 *            - cpf da pessoa a ser associada
	 * @param codigoProjeto
	 *            - projeto ao qual o graduando ser� associado
	 * @param valorHora
	 *            - valor R$ da hora do graduando
	 * @param qntHoras
	...
	public void associaGraduando(String cpfPessoa, int codigoProjeto, double valorHora, int qntHoras) {
		...
		try {
			...
			participacao = new ParticipacaoGraduando(projeto, pessoa, qntHoras, valorHora);
	...
	/**
	 * Faz a associação de um profissional a um projeto e registra em pessoa e
	 * projeto a nova participacao
	 * 
	 * @param cpfPessoa
	 *            - cpf da pessoa a ser associada
	 * @param codigoProjeto
	 *            - projeto ao qual o profissional será associado
	 * @param cargo
	 *            - cargo em que o profissional trabalha
	 * @param valorHora
	 *            - valor R$ da hora do graduando
	 * @param qntHoras
	 *            - quantidade de horas semanais dedicadas ao projeto
	...
	public void associaProfissional(String cpfPessoa, int codigoProjeto, String cargo, double valorHora, int qntHoras) {
		...
		try {
			...
			participacao = new ParticipacaoProfissional(projeto, pessoa, qntHoras, valorHora, cargo);
		} catch (ValidacaoException | CpcException e) {
			throw new CpcException(e, "Erro na associacao de pessoa a projeto: " + e.getMessage());
		}
	...
	/**
	 * Faz a associação de um pós-graduando a um projeto e registra em pessoa e
	 * projeto a nova participacao
	 * 
	 * @param cpfPessoa
	 *            - cpf da pessoa a ser associada
	 ...
	 *            - projeto ao qual o profissional será associado
	 * @param nivel
	 *            - String indicando qual o nível da pós graduação do aluno,
	 *            podendo ser mestrado ou doutorado
	 * @param valorHora
	 *            - valor R$ da hora do graduando
	 * @param qntHoras
	 *            - quantidade de horas semanais dedicadas ao projeto
	...
	public void associaPosGraduando(String cpfPessoa, int codigoProjeto, String nivel, double valorHora, int qntHoras) {
		...
		try {
			...
			participacao = new ParticipacaoPosGraduando(projeto, pessoa, qntHoras, valorHora, nivel);
	 ...
	 * @param codigoProjeto
	 *            - codigo do projeto a ser removida a participacao
	 */
	 ...
	 * 
	 * @param cpfPessoa
	 *            - cpf da pessoa que sera calculado os pontos
	 * @return - retorna um double com a quantidade de pontos da pessoa
	 *         portadora do cpf
	 */
